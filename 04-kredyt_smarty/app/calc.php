...
function validate(&$form,&$infos,&$msgs,&$hide_intro){
	...
	if ( $form['z'] == "") $msgs [] = 'Nie podano ilości lat spłaty';
	
	//nie ma sensu walidować dalej gdy brak parametrów
	if ( count($msgs)==0 ) {
		// sprawdzenie, czy $x i $y są liczbami całkowitymi
		if (! is_numeric( $form['z'] )) $msgs [] = 'Ilość lat nie jest wartością całkowitą';
	}
...
function process(&$form,&$infos,&$msgs,&$result){
	...
	$result = ($form['x']*(1+($form['y']/100)))/($form['z']*12);
...
$smarty->assign('page_description','Przybliżone obliczanie raty kredytu');
